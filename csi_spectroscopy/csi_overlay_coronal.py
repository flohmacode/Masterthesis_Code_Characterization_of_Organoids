...
#Load data and specify scans
study_directory_img = './csi_data/atpspec/20260107_145049_MDC_0230_fm_organoids_260107_organoid_atp_spec2_1_15'
scan_img_number = 9
slice_idx_img = 1

fig_temp, ax_temp, img_mat = mr_imaging.get_reconstructed_img(study_directory_img, scan_img_number, slice_idx_img, 'coronal')
plt.close()
...
fig, ax = csiplots.csi_overlay_coronal(
    spects=spects,
    img_array=img_mat,
...
plt.savefig('./fig_csi/coronal_nmr')
plt.show()